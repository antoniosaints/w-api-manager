    ...
    <>
      <Card as="section" variant="panel" className="single-panel">
        ...
        <form className="stacked-form form-grid" onSubmit={submit}>
          ...
          <Input label="JID ou numero do bot" value={form.instanceJid} onChange={(event) => setForm({ ...form, instanceJid: event.target.value })} placeholder="5511999999999@s.whatsapp.net" />
